      ...
      <Row>
        <Col>
          <div className="ui form" style={{width: 420, marginTop: 10}}>
            <div className="field">
              <label>Name</label>
              <input type="text" value={this.state.name} placeholder="Enter Game Name..."
                onChange={e => this.setState({name: e.target.value})}
              />
            </div>
          </div>
          <Form style={{marginTop: 10}}>
            <Form.TextArea label='Description' value={this.state.desc} placeholder='Game Description...'
        ...
        <Col>
          <Row>
            <Col>
              <Image style={{marginTop: 25, marginLeft: 30}} src={gameImage} size='small' />
            </Col>
            <Col>
              <input type="file" className="inputfile" id="fileinput" />
              <label style={{marginTop: 70, marginRight: 30, backgroundColor: "#2A9D8F",color: "white"}} className="ui small floated button">
